...
**写于**：2026-09-20 14:27（v46；波次以 `loop.md` 为准）
**读者**：新开对话的 Agent（不是给用户的作业）
**取代**：v45（仍写 HEAD `cad4c22` —— 已过时）

**当前总状态**：**▶ 运行中（主树父写）**。HEAD `f6a6b1d`。前端 153/153。
wave122 已落。常设规则：父自选推进，不等人。
...
见 `tasks/evo-collab-extreme/loop.md`。前端 **153/153** · HEAD `f6a6b1d`。父自选推进。
门禁轴可 idle；wave122 mall 岛经 usecase。下刀 loadUserCoupon / 其它域岛。拒 ReferralBinding/CreditLedgerDebt。
